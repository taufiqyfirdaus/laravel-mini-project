            ...
            <div class="position-fixed text-white" style="margin-top:130px; width:18vw;">
                ...
                <div id="recommendations">
                    @foreach ($randomUsers as $item)
                        <div class="row mb-2 user-recommendation" data-user-id="{{ $item->id }}">
                ...
                <hr>
                <p class="text-secondary" style="font-size: 12px">Terms of Service Privacy Policy Cookie Policy Accessibility Ads info more © 2024 Sosmed</p>
            </div>
        </div>
    </div>
    <script>
