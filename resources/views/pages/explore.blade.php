            ...
            <div class="navbar-collapse justify-content-md-center">
                <div class="d-flex flex-column align-items-center w-50">
                    ...
                    <div class="row mt-1 w-50">
                        <div class="col-md-11">
                            <input type="text" name="search" id="search" class="form-control custom-input text-white border-secondary ms-3" placeholder="Cari User" style="background-color: black;">
                        </div>
                        <div class="col-md-1">
